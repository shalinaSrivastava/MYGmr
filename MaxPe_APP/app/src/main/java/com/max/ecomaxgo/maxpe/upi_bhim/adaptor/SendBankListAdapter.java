...
public class SendBankListAdapter extends RecyclerView.Adapter<SendBankListAdapter.MyViewHolder> {
    private LayoutInflater inflater;
    List<Bank> banks;
    Context ctx;
    BankOnItemClickListner bankOnItemClickListner;

    public SendBankListAdapter(Context ctx, List<Bank> banks, BankOnItemClickListner bankOnItemClickListner){
