package com.max.ecomaxgo.maxpe.water
...
class WaterActivity : AppCompatActivity() {
    ...
    private fun getOperator(){
        val call: Call<Bbps> =
            retrofitconfig.endpoints.getDthOperator(Constant.skey, "WATER")
        call.enqueue(object : Callback<Bbps> {
            override fun onResponse(call: Call<Bbps>, response: Response<Bbps>) {
                ...
                if (bbpsModel.status.equals("1")){
                    ...
                    bbpsAdapter = BbpsGetOperatorAdapter(this@WaterActivity, operaterDetails)
