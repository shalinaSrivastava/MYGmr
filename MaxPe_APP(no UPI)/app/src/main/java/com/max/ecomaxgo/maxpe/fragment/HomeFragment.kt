...
import com.max.ecomaxgo.maxpe.model.dashboad.ApiClient
import com.max.ecomaxgo.maxpe.model.dashboad.ApiInterface
...
class HomeFragment : Fragment(){
    ...
    private lateinit var roundImage: RoundedImageView
    ...
    private fun initView(){
        ...
        roundImage = views.findViewById(R.id.roundImage)
        ...
        tvMobileNumber = views.findViewById(R.id.tvMobileNumber)

        if (maxPreference.UserFName.equals("")){
            tvMobileNumber.setText(maxPreference.UserMobileNum)
        }else{
            var fName = maxPreference.UserFName
            var lName = maxPreference.UserLName
            tvMobileNumber.text = "Hi "+fName
            //isNewDialog.dismiss()
        }
